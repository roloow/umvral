...
var NotasPage = (function () {
    ...
    NotasPage.prototype.mostrarError = function (text) {
        var alert = this.alertCtrl.create({
            title: 'Error',
            subTitle: text,
            buttons: ['OK']
                                ...
                                'Cancelar',
                                {
                                    ...
                                    handler: function (data) {
                                        if (data.nota && data.nombre) {
                                            _this.count += 1;
                                            _this.notas.push({ nota: data.nota, nombre: data.nombre });
                                        }
                                        else {
                                            if (data.nota === "" && data.nombre === "")
                                                _this.mostrarError("Nombre y Nota inválidos.");
                                            else if (data.nombre === "")
                                                _this.mostrarError("Nombre inválido.");
                                            else
                                                _this.mostrarError("Nota inválida.");
                                        }
                                    }
                                }
                            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_experiencia_1_experiencia_experiencia__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_perfil_perfil__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_notas_notas__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_cursos_cursos__ = __webpack_require__(211);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_perfil_perfil__ = __webpack_require__(209);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_notas_notas__ = __webpack_require__(210);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_cursos_cursos__ = __webpack_require__(211);
