...
var HelpPrueba1Page = (function () {
    function HelpPrueba1Page(navCtrl, umvralApiProvider) {
        this.navCtrl = navCtrl;
        this.umvralApiProvider = umvralApiProvider;
        this.respuestas = ['-', '-', '-', '-', '-', '-', '-', '-', '-', '-'];
