...
urlpatterns = [
    ...
    re_path(r'course/api/(?P<course>\w+)/(?P<student_id>\w+)$', views.getStudentResultData, name='student_getdata'),
    re_path(r'course/api/(?P<course>\w+)/(?P<student_id>\w+)/(?P<exp_id>\w+)$', views.getStudentResultData, name='student_getdata'),
